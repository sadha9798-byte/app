...
const COMPANY_DEFAULTS = {
  ...
  phones: {
    bookings: '+91 63602 00841', support: '+91 88703 21177', coaching: '+91 87489 81178',
    business: '+91 81050 86245', general: '+91 97389 07139',
  },
  emails: {
    bookings: 'athletixcelsports@gmail.com', support: 'athletixcelsports8817@gmail.com',
    business: 'info@atletixcelsports.in', coaching: 'support@atletixcelsports.in',
  },
  phone: '+91 63602 00841',
  email: 'athletixcelsports@gmail.com',
  whatsapp: '+91 63602 00841',
  gstNumber: '29ABCDE1234F1Z5',
  // Turf operating capacity (used by dashboard)
  numTurfs: 1,
  openHour: 6,    // 6 AM
  closeHour: 23,  // 11 PM
};
...
export async function ensureSeed() {
  ...
  // Company settings — only add missing fields, never overwrite user changes
  const settings = db.collection('settings');
  const existingSettings = await settings.findOne({ key: 'company' });
  if (!existingSettings) {
    ...
    for (const [k, v] of Object.entries(COMPANY_DEFAULTS)) {
      if (existingSettings[k] === undefined) missing[k] = v;
    }
    if (Object.keys(missing).length) {
      await settings.updateOne({ key: 'company' }, { $set: missing });
    }
  }
